...
export default function Footer() {
  return (
    <footer className="bg-gray-900 border-t border-gray-800 py-12 px-[100px]">
      <div className="mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li><Link href="#pricing" className="text-gray-400 hover:text-white transition-colors">Bảng giá</Link></li>
              <li><Link href="#" className="text-gray-400 hover:text-white transition-colors">Tài liệu</Link></li>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li><Link href="#" className="text-gray-400 hover:text-white transition-colors">Cộng đồng</Link></li>
              <li><Link href="#" className="text-gray-400 hover:text-white transition-colors">Trạng thái hệ thống</Link></li>
        ...
        <div className="border-t border-gray-800 mt-12 pt-8 text-center text-gray-400">
          <p>&copy; {new Date().getFullYear()} Flowly. Tất cả các quyền được bảo lưu.</p>
        </div>
      </div>
    </footer>
  );
